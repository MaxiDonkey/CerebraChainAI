...
//  FValue := AValue;
//
//  LocalHandlers := FThenHandlers.ToArray;
//  FThenHandlers.Clear;
//  FCatchHandlers.Clear;
//
//  TThread.Queue(nil,
...
//procedure TPromise<T>.Reject(AError: Exception);
//var
//  LocalHandlers: TArray<TProc<Exception>>;
//begin
//  if FState <> psPending then
//    Exit;
//
...
//  FError := AError;
//
//  LocalHandlers := FCatchHandlers.ToArray;
//  FThenHandlers.Clear;
//  FCatchHandlers.Clear;
//
//  TThread.Queue(nil,
